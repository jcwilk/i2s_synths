/** Phase 1/2 USB realtime frame layout (shared by bridge server and PWA client). */

import { SAMPLE_RATE, BUFFER_LEN, PERIOD_MS } from '../shared/audio-constants.js';

export { SAMPLE_RATE, BUFFER_LEN, PERIOD_MS };
...
export function buildEnterUsbFrame(mode = BRIDGE_ENTER_MODE_INJECTED) {
...
export function nameToFirmwareKind(name) {
  return MODULE_KIND_TO_FIRMWARE[name] ?? null;
}
